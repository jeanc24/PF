(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('styled-components'), require('@microlink/mql'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['react', 'styled-components', '@microlink/mql', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.microlink = factory(global.React, global.styled, global.mql, global.ReactDOM));
})(this, (function (React, styledComponents, mql, reactDom) { 'use strict';
  ...
  function microlink (selector, opts, rootNode) {
    return toArray(selector).forEach(function (el) {
      ...
      reactDom.createRoot(rootNode || el).render(
        React.createElement(
          Microlink,
          Object.assign(
            {
